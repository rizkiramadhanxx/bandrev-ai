...
export default function HeroPublication() {
  ...
  return (
    <div className="flex justify-center bg-no-repeat pt-[50px]  md:pt-[60px] items-center bg-cover min-h-[100vh] bg-[url(/banner/publication.png)]">
      <div className="main-container w-[100%]">
        <div className="flex items-center">
          <div ref={boxRef}>
            ...
            <div className="max-w-[400px] mt-[20px] text-white">
