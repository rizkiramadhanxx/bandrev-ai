...
export default function HeroAINewsletter() {
  ...
  return (
    <div className="flex justify-center bg-no-repeat pt-[50px] md:pt-[60px] items-center bg-cover min-h-[100vh] bg-[url(/banner/ai-newsletter.png)]">
