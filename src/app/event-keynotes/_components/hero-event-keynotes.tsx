...
export default function HeroEventKeynotes() {
  ...
  return (
    <div className="flex justify-center bg-no-repeat pt-[50px] md:pt-[60px] items-center bg-cover min-h-[100vh] bg-[url(/banner/event-keynote.png)]">
      <div className="main-container w-[100%]">
        <div className="flex items-center">
          <div ref={boxRef}>
            <h1 className="text-[21px] lg:text-[30px]  text-white">&</h1>
